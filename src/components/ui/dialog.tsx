...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // En un móvil, `w-full` dejaba el diálogo pegado a los dos bordes y sin
        // esquinas redondeadas, y sin altura máxima los formularios largos se
        // salían por abajo sin poder desplazarse. Con el hueco lateral, el tope
